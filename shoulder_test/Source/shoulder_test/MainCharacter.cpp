...
void AMainCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	UE_LOG(LogTemp, Warning, TEXT("SetupPlayerInputComponent is called."));
	// Set up action bindings
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {

		//Jumping
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Triggered, this, &AMainCharacter::JumpCheck);
		EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Completed, this, &AMainCharacter::StopJumpingCheck);
...
void AMainCharacter::JumpCheck(const FInputActionValue& Value)
{
...
void AMainCharacter::StopJumpingCheck(const FInputActionValue& Value)
{
	if (canclimb) //사다리를 오를 수 있을 때
	{
		// 비행 모드 활성화
...
void AMainCharacter::OnBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
void AMainCharacter::OnEndOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
